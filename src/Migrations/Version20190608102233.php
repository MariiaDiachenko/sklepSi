 ...
 */
final class Version20190608102233 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE disposal_details (id INT AUTO_INCREMENT NOT NULL, disposal_id INT DEFAULT NULL, copied_price INT NOT NULL, quantity INT NOT NULL, INDEX IDX_C345DD287FEC5C6B (disposal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
